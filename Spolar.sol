...
contract Spolar is ERC20Burnable, Operator {
    ...
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 41000e18;
    uint256 public constant COMMUNITY_FUND_POOL_ALLOCATION = 4500e18;
    uint256 public constant DEV_FUND_POOL_ALLOCATION = 4500e18;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("SPOLAR", "SPOLAR") {
        ...
        _mint(msg.sender, 1e18); // mint 1 POLAR Share for initial pools deployment
