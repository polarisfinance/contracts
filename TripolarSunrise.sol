...
import "./interfaces/ITripolarTreasury.sol";

contract TripolarShareWrapper {
...
*/
contract TripolarSunrise is TripolarShareWrapper, ContractGuard {
    using SafeERC20 for IERC20;
    ...
    function getTripolarPrice() external view returns (uint256) {
        return treasury.getTripolarPrice();
    }
