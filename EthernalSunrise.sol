...
import "./interfaces/IEthernalTreasury.sol";

contract EthernalShareWrapper {
...
*/
contract EthernalSunrise is EthernalShareWrapper, ContractGuard {
    using SafeERC20 for IERC20;
    ...
    function getEthernalPrice() external view returns (uint256) {
        return treasury.getEthernalPrice();
    }
